...
public class HintText : MonoBehaviour
{
    ...
    void Start()
    {
        sceneHintMap.Add("Room 1.1 - Marston", new string[] { "The painting has color significance.", "Count the number of lines for each color.", "The computer distinguishes the color order." });
        ...
        sceneHintMap.Add("Room 4 - Malachowsky Hall", new string[] { "The fuses have short-circuited, they do not work.", "Observe the sentence for something strange.", "Look toward the calculator for a unique button." });
