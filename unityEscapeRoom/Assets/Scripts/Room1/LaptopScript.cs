...
public class LaptopScript : MonoBehaviour
{
    ...
    //    originalRot = new Vector3(transform.rotation.x, transform.rotation.y, transform.rotation.z);
        GameObject.Find("Laptop_Back_Button").GetComponent<Renderer>().enabled = false;
    }
    ...
    {
        MoveToFront();
        if (GameObject.Find("Laptop_Back_Button").GetComponent<BackArrowScript>().backButtonClicked) {
    ...
    void MoveToFront() {
        if(moving == true){
            ...
            if(transform.position == target.position + target.forward + laptopVector){
                ...
                GameObject.Find("Laptop_Back_Button").GetComponent<Renderer>().enabled = true;
            }
    ...
    void  MoveToOriginalPosition() {
        ...
        //    transform.eulerAngles = originalRot;
            ...
            if(transform.position == originalPos){
                ...
                moving2 = false;
                inFront = false;
                GameObject.Find("Laptop_Back_Button").GetComponent<BackArrowScript>().backButtonClicked = false;
                GameObject.Find("Laptop_Back_Button").GetComponent<Renderer>().enabled = false;
                //transform.eulerAngles = originalRot;    
            }
